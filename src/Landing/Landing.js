      ...
      <section className="hero tutorial-section">
        <div className="content-area">
          ...
          <p className="section-para">
            We get it. You have a lot of poker ranges. You tried storing them in Flopzilla, but only being able to look at one range at a time is so limiting. You tried making your own multi-range charts in a spreadsheet, but they are so ugly and quickly switching between charts can be difficult. Range Wizard gives you the perfect tool to create beautiful, easy to use poker charts.
          </p>
          <Link
            to="/charts"
            className="cta-btn"
